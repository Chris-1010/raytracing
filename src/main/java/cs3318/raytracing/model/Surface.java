...
public class Surface {
    ...
    public Surface(float rval, float gval, float bval,
            float ambientReflectionCoefficient, float diffuseReflectionCoefficient, float specularReflectionCoefficient,
            float exponent,
...
// public Surface(float rval, float gval, float bval,
// float ambientReflectionCoefficient, float diffuseReflectionCoefficient, float
// specularReflectionCoefficient, float exponent,
// float reflectanceCoefficient, float transmissionCoefficient, float index) {
// rIntrinsic = rval; gIntrinsic = gval; bIntrinsic = bval;
// phong = new PhongModel(ambientReflectionCoefficient,
// diffuseReflectionCoefficient, specularReflectionCoefficient,
// transmissionCoefficient,reflectanceCoefficient * I255,
// exponent, index);
